...
public class Brain : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if(alive)
		{
			...
			DistanceAlive = Vector3.Distance (new Vector3( transform.position.x,0,transform.position.z),
				new Vector3(m_startPos.x,0,m_startPos.z));
		}
    }
}
